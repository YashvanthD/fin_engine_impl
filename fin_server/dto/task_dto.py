...
class TaskDTO:
    ...
    def from_doc(cls, doc: Dict[str, Any]):
        ...
        return cls(
            ...
            assignedTo=d.get('assignedTo') or d.get('assigned_to') or d.get('assignee'),
            status=d.get('status'),
    ...
    def from_request(cls, payload: Dict[str, Any]):
        return cls(
            ...
            assignedTo=payload.get('assignedTo') or payload.get('assigned_to') or payload.get('assignee'),
    ...
    def to_db_doc(self) -> Dict[str, Any]:
        ...
        db = {
            ...
            'assignee': doc.get('assignedTo') or doc.get('assigned_to'),
